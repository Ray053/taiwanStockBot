...
class Settings(BaseSettings):
    ...
    # Polymarket slugs (update if markets change; fallback returns 0.5 if slug not found)
    poly_fed_cut_slug: str = Field(default="will-the-fed-cut-rates-in-2026")
    poly_nvidia_beat_slug: str = Field(default="will-nvidia-beat-q1-2026-earnings")
    poly_taiwan_strait_slug: str = Field(default="taiwan-strait-incident-2026")
    poly_china_gdp_slug: str = Field(default="will-china-miss-gdp-target-2026")
    poly_oil_90_slug: str = Field(default="will-oil-price-exceed-90-in-2026")
